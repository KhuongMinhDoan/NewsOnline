               ...
               <div class="newsair-notice-started updated notice notice-get-started-class is-dismissible" data-notice="get_started">
                <div class="newsair-notice clearfix">
                    <div class="newsair-notice-content">
                        ...
                        <a class="newsair-btn-get-started button button-primary button-hero newsair-button-padding" href="<?php echo esc_url( admin_url( '/customize.php' ) ); ?>" data-name="" data-slug=""><?php esc_html_e( 'Customize Site', 'newsair' ) ?></a>
